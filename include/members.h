...
// B4:E6:2D:9C:DF:45        Sound Light Wrover
...
static uint8_t sound_light_wrover[] = { 0xB4, 0xE6, 0x2D, 0x9C, 0xDF, 0x45 };

#define MOTOR_CONTROLLER_MAC        motor2
#define MAIN_CONTROLLER_MAC         master
#define SOUND_LIGHT_CONTROLLER_MAC  sound_light_wrover
